...
| transformers | **必须 4.46.x**。新版（4.50+）API 不兼容（详见 `.codestable/compound/2026-05-24-decision-transformers-version-pin.md`） |
...
| `accept_length` 远低于预期（如 < 3） | 大概率是 SAM-Decoding 与 EAGLE3 增量约定不匹配（持久状态 vs 累积状态错位） | 详见 [pitfall](../.codestable/compound/2026-05-24-learning-samd-eagle3-incremental-state-machine.md) |
...
- 方案：`.codestable/features/2026-05-23-eagle3-integration/eagle3-integration-design.md`
- 验收报告：`.codestable/features/2026-05-23-eagle3-integration/eagle3-integration-acceptance.md`
- 架构索引：`.codestable/architecture/ARCHITECTURE.md` 第 3 / 5 节
- 决策（5 条 constraint ADR）：`.codestable/compound/2026-05-24-decision-eagle3-*.md` + `2026-05-24-decision-transformers-version-pin.md` + `2026-05-24-decision-samd-batch-size-one.md`
- 实施 pitfall：`.codestable/compound/2026-05-24-learning-samd-eagle3-incremental-state-machine.md`
